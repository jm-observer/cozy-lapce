...
fn test_line() -> Result<()> {
    ...
    // }
    // for origin_lines in &lines.origin_lines {
    //     info!("{:?}", origin_lines);
    // }
    // debug!("{}", get_origin_line(&lines, 1));X

    {
        let line = de_serde_line();
    ...
    de_serde_folded_line_1();
    {
        let line = de_serde_folded_line_1();
        assert_eq!(lines.origin_lines[1].phantom.texts, line[0].phantom.texts);
        assert_eq!(lines.origin_lines[3].phantom.texts, line[1].phantom.texts);
        assert_eq!(lines.origin_lines[5].phantom.texts, line[2].phantom.texts);
    }
    de_serde_folded_line_2();
    {
        let line = de_serde_folded_line_2();
        assert_eq!(lines.origin_lines[1].phantom.texts, line[0].phantom.texts);
        assert_eq!(lines.origin_lines[3].phantom.texts, line[1].phantom.texts);
        assert_eq!(lines.origin_lines[5].phantom.texts, line[2].phantom.texts);
    }
...
fn de_serde_line() -> Vec<OriginLine> {
    let str =
...
fn de_serde_folded_line_1() -> Vec<OriginLine> {
    let str =
...
fn de_serde_folded_line_2() -> Vec<OriginLine> {
    let str =
